...
{
	public class RoleToMenuBLL : BaseBLL<RoleToMenu>
	{
		private IRoleToMenuDAL roleToMenuDAL;
		public RoleToMenuBLL(): base()
		{
			...
			this.roleToMenuDAL = (IRoleToMenuDAL)base.baseDal;
		}
	}
}
