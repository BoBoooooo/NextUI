...
namespace Next.WorkFlow.Entity.WorkFlowInstalledSub
{
    /// <summary>
    /// 数据库连接结构体
    /// </summary>
...
namespace Next.WorkFlow.Entity.WorkFlowInstalledSub.StepSet
{
    /// <summary>
    /// 步骤行为实体
    /// </summary>
    ...
    public class Behavior
    {
        ...
        /// </summary>
        public string HandlerStepID { get; set; }
        /// <summary>
        /// 当处理者类型为 8字段值 时的字段
        /// </summary>
    ...
    {
        /// <summary>
        /// 按钮ID(为string则是按钮库中的按钮，否则为其它特定功能按钮)
        /// </summary>
        public string ID { get; set; }
        /// <summary>
        /// 按钮说明
