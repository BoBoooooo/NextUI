...
{
    public class OperationLogController : BusinessController<OperationLogBLL, OperationLog>
    {
        //
        // GET: /Jssjw/Loan/
        ...
        public ActionResult Edit(string ID, string type)
        {
            ...
            if (type != "Add")
            {
                item = BLLFactory<OperationLogBLL>.Instance.FindByID(ID);

                //ViewBag.item = item;
            }
            else
            {
                item = new OperationLog();
        ...
        public override ActionResult FindWithPager()
        {
            ...
            List<OperationLog> list = baseBLL.FindWithPager(where, pagerInfo);
        ...
        private string getRealNameByColumnName(string id)
        {
            ...
            {
                StreamReader sr = System.IO.File.OpenText(Server.MapPath("/json/Next/OperationLog/ColumnName.json"));
