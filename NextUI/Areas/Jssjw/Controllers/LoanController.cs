...
{
    public class LoanController : BusinessController<LoanBLL, Loan>
    {
        //
        // GET: /Jssjw/Loan/
        ...
        public ActionResult Edit(string ID, string type)
        {
            ...
            if (type != "Add")
            {
                item = BLLFactory<LoanBLL>.Instance.FindByID(ID);
        ...
        public override ActionResult FindWithPager()
        {
            ...
            List<Loan> list = baseBLL.FindWithPager(where, pagerInfo);
        ...
        private string getRealNameByColumnName(string id)
        {
            ...
            {
                StreamReader sr = System.IO.File.OpenText(Server.MapPath("/json/Jssjw/Organization/ColumnName.json"));
