...
{
    public class DBConnectionController : BusinessController<DBConnectionBLL, DBConnection>
    {
        //
        // GET: /Jssjw/Loan/
        ...
        public ActionResult Edit(string ID, string type)
        {
            ...
            if (type != "Add")
            {
                item = BLLFactory<DBConnectionBLL>.Instance.FindByID(ID);
        ...
        public override ActionResult FindWithPager()
        {
            ...
            List<DBConnection> list = baseBLL.FindWithPager(where, pagerInfo);
        ...
        private string getRealNameByColumnName(string id)
        {
            ...
            {
                StreamReader sr = System.IO.File.OpenText(Server.MapPath("/json/Next/DBConnection/ColumnName.json"));
